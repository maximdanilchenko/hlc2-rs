...
use actix_web::{HttpResponse, Responder, Result, HttpRequest};
...
impl DataBase {
    ...
    pub fn from_file(path: &'static str) -> DataBase {
    ...
    pub fn from_file_in_place(path: &'static str) -> DataBase {
        println!("{:?}", mem::size_of::<Account>());
    ...
    fn subtract_from_group(&mut self, acc: &Account, joined: Option<u32>, _birth: Option<u32>) {
    ...
    fn add_to_group(&mut self, acc: &Account, joined: Option<u32>, _birth: Option<u32>) {
        self.groups.entry(vec![GroupKeys::Sex, GroupKeys::Status])
            .and_modify(|index|
                *index
                    .entry(
    ...
    fn insert_to_domains(&mut self, mail: String, _uid: u32) -> u16 {
    ...
    pub fn update_account(&mut self, uid: u32, account: AccountOptional, req: HttpRequest<AppState>) -> Result<AsyncResult<HttpResponse>> {
    ...
    pub fn insert(&mut self, account: AccountFull, req: HttpRequest<AppState>) -> Result<AsyncResult<HttpResponse>> {
    ...
    pub fn update_likes(&mut self, likes: LikesRequest, req: HttpRequest<AppState>) -> Result<AsyncResult<HttpResponse>> {
    ...
    pub fn filter(&self, filters: Filters) -> Result<serde_json::Value, ()> {
    ...
    pub fn recommend(&self, uid: u32, suggest_filters: SuggestRecommend) -> Result<serde_json::Value, StatusCode> {
        ...
        for (uid, _account) in account.interests
            .iter()
    ...
    pub fn suggest(&self, uid: u32, suggest_filters: SuggestRecommend) -> Result<serde_json::Value, StatusCode> {
    ...
    pub fn group(&self, group_filters: Group) -> Result<serde_json::Value, StatusCode> {
